                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={e => updateResumeData({ personalInfo: { ...resumeData.personalInfo, jobTitle: e.target.value } })}
                                  className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                />
                              </div>
                              ...
                              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                                    ...
                                    onClick={() => {
                                      ...
                                      updateResumeData({
                                        personalInfo: {
                                          ...
                                          customLinks: [...(resumeData.personalInfo.customLinks || []), newLink],
                                        },
                                      });
                                    }}
                                ...
                                <div className="space-y-3">
                                  {(resumeData.personalInfo.customLinks || []).map((link, index) => (
                                    <div key={link.id} className="flex gap-2">
                                      <input
                                        ...
                                        value={link.platform}
                                        onChange={e => {
                                          const updated = [...(resumeData.personalInfo.customLinks || [])];
                                          updated[index] = { ...updated[index], platform: e.target.value };
                                          updateResumeData({
                                            personalInfo: { ...resumeData.personalInfo, customLinks: updated },
                                          });
                                        }}
                                      ...
                                      <button
                                        onClick={() => {
                                          const updated = (resumeData.personalInfo.customLinks || []).filter((_, i) => i !== index);
                                          updateResumeData({
                                            personalInfo: { ...resumeData.personalInfo, customLinks: updated },
                                          });
                                        }}
                                  ...
                                  {(!resumeData.personalInfo.customLinks || resumeData.personalInfo.customLinks.length === 0) && (
                                    <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">
                                      Add links to coding platforms like LeetCode, CodeChef, HackerRank, Codeforces, etc.
                                    </p>
                                  )}
                                </div>
                              </div>
                          ...
                          {section.id === 'custom' && (
                            <div className="space-y-4">
                              ...
                              {(resumeData.customSections || []).map((customSection, sectionIndex) => (
                                <div key={customSection.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-4">
                                  {/* Section Title */}
                                  <div className="flex items-center gap-2">
                                    <input
                                      type="text"
                                    ...
                                    <button
                                      onClick={() => {
                                        const updated = (resumeData.customSections || []).filter((_, i) => i !== sectionIndex);
                                        updateResumeData({ customSections: updated });
                                      }}
                                      className="p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
                                  ...
                                  <div className="space-y-3">
                                    {customSection.items.map((item, itemIndex) => (
                                      <div key={item.id} className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg space-y-2">
                                        <div className="flex items-start gap-2">
                                          <div className="flex-1 space-y-2">
                                            <input
                                              ...
                                              onChange={(e) => {
                                                const updated = [...(resumeData.customSections || [])];
                                                updated[sectionIndex].items[itemIndex] = { ...item, title: e.target.value };
                                                updateResumeData({ customSections: updated });
                                              }}
                                            ...
                                            <input
                                              ...
                                              onChange={(e) => {
                                                const updated = [...(resumeData.customSections || [])];
                                                updated[sectionIndex].items[itemIndex] = { ...item, subtitle: e.target.value };
                                                updateResumeData({ customSections: updated });
                                              }}
                                              className="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white"
                                            ...
                                            <input
                                              ...
                                              onChange={(e) => {
                                                const updated = [...(resumeData.customSections || [])];
                                                updated[sectionIndex].items[itemIndex] = { ...item, date: e.target.value };
                                                updateResumeData({ customSections: updated });
                                              }}
                                              className="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white"
                                            ...
                                            <textarea
                                              ...
                                              onChange={(e) => {
                                                const updated = [...(resumeData.customSections || [])];
                                                updated[sectionIndex].items[itemIndex] = { ...item, description: e.target.value };
                                                updateResumeData({ customSections: updated });
                                              }}
                                              rows={3}
                                              className="w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white"
                                    ...
                                    <button
                                      ...
                                      className="w-full py-2 px-4 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg flex items-center justify-center gap-2 transition-colors"
                                    >
                                      <Plus className="w-4 h-4" />
                                      Add Item
                                    </button>
                              ...
                              {(!resumeData.customSections || resumeData.customSections.length === 0) && (
                                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                                  <p>No custom sections yet. Click "Add Custom Section" to get started.</p>
                                  <p className="text-sm mt-2">Perfect for Certifications, Awards, Publications, Volunteer Work, etc.</p>
                                </div>
                              )}
                            </div>
                          )}
